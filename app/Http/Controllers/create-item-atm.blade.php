...
<div class="row">
    <div class="col-md-12">
    <form action="/store-item-atm/{{$atm->id}}" class="form-input-section" method="POST" enctype="multipart/form-data" id="my-form">
        @csrf
        <div class="row mb-4">
            <label for="" class="col-md-2 text-end fw-bold py-1">Nama Item</label>
            <div class="col-md-6">
                <input type="text" class=" form-input" name="itematm_name" placeholder="Masukan Nama Item" required>
            </div>
        </div>
        <div class="row mb-4">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body  modal-upload p-5 text-center">
          ...
          <h1 class="or">Or</h1>
          <input type="file" class="form-input-section upload-dropzone" name="itematm_image" id="imageUpload" accept=".png, .jpg, .jpeg" required>
